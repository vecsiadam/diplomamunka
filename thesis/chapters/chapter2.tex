...
\Section{Kafka architektúra}
 \begin{figure}[ht]
	\centering
	\epsfig{file=images/kafka-architecture.png,scale=0.5}
...
\begin{figure}[ht]
	\centering
	\epsfig{file=images/kafka-partitions.png,scale=0.6}
...
\begin{figure}[ht]
	\centering
	\epsfig{file=images/kafka-elastic.png,scale=0.6}
	\caption{Kafka logs} 
...
\begin{figure}[ht]
	\centering
	\epsfig{file=images/kafka-java.png,scale=0.5}
	\caption{Kafka logs} 
